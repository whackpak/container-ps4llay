...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ps4llay.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ps4llay.containers.anotherwebservice.com/
...
```
git clone git@github.com:whackpak/container-ps4llay.git
cd container-ps4llay
```
...
```
docker attach container-ps4llay
```
